              ...
              <td className="px-6 py-1 ">
                <div className="flex justify-between items-center ">
                  ...
                  <Button className="*:fill-[#343F52] hover:bg-[#e5e7eb] bg-transparent border rounded-l-md max-h-[30px] " onClick={() => setSelectedEmailTab(email)}> 
                    ...
                    <Button isDisabled={!isAdmin && !isTwofaEnabled} onClick={() => openDeleteModal(email)} className="  max-h-[30px] border border-l-0 bg-transparent hover:bg-[#e5e7eb] *:fill-[#343F52] "> 
