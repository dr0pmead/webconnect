      ...
      <table className="table-auto w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-[#E9EBF3] text-sm text-[#343F52] font-medium">
            ...
            <th className="px-6 xl:py-3 lg:py-2.5 md:py-2 w-1/5">Наименование</th>
            <th className="px-6 xl:py-3 lg:py-2.5 md:py-2 w-1/4">Пользователь</th>
            <th className="px-6 xl:py-3 lg:py-2.5 md:py-2 w-1/3">Пароль</th>
            <th className="px-6 xl:py-3 lg:py-2.5 md:py-2 w-1/6">Действия</th>
          </tr>
        </thead>
        <tbody>
        {currentEmails.map((email) => (
            <tr key={email._id} className="border-b font-medium text-[#343F52]">
              ...
              <td className="px-6 xl:py-3 lg:py-2.5 md:py-2">
            ...
            <HighlightText text={email.username} highlight={searchTerm} />
              ...
              <td className="px-6 xl:py-3 lg:py-2.5 md:py-2">
                ...
                {showPassword[email._id] ? (
                    ...
                    >
                        ...
                        disabled={false}
                        className="cursor-pointer hover:bg-[#e5e7eb] text-sm border w-full rounded-lg px-3 py-1.5 text-[#343F52] outline-none duration-150"
              ...
              <td className="px-6 xl:py-3 lg:py-2.5 md:py-2 ">
                <div className="flex justify-between items-center ">
                  <ButtonGroup>
                  <Button className="*:fill-[#343F52] hover:bg-[#e5e7eb] bg-transparent border" onClick={() => setSelectedEmailTab(email)}> 
